...
write(errors_ess, "rough ess errors")
write(ess_exploration_factor, "rough ess exploration factor")
write.csv2(samples, "rough network ess samples")
...
write(errors_acceptance, "rough acceptance errors")
write(ar_exploration_factor, "rough acceptance rate exploration factor")
write.csv2(samples, "rough network acceptance samples")
